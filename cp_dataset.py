...
class CPDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        #        transforms.ToTensor(),   \
        #        transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))]) Commented by HMA
    ...
    def __getitem__(self, index):
        ...
        if im.mode == 'RGB':
            ...
            im = self.gray_transform(im)  # Convert grayscale to 3-channel if needed
            im = self.rgb_transform(im)  # Apply RGB normalization after conversion
